...
tape( 'the returned function invokes a predicate function once for each element in a collection (value,next)', function test( t ) {
	...
	noneByAsync = factory( predicate );

	arr = [ 1, 2, 3 ];
	expected = [ 1, 2, 3 ];
	i = -1;

	noneByAsync( arr, done );
...
tape( 'the function supports returning a function for processing collection elements sequentially (in series)', function test( t ) {
	...
	noneByAsync = factory( opts, predicate );
...
tape( 'if a predicate function returns a truthy test result, the returned function suspends execution and immediately returns `false` for the test result (series)', function test( t ) {
	var noneByAsync;
	var count;
	var opts;
	var arr;
...
tape( 'if a predicate function returns a truthy test result, the returned function suspends execution and immediately returns `false` for the test result (concurrent; limit)', function test( t ) {
	var noneByAsync;
	var count;
	var opts;
	var arr;
...
tape( 'if a predicate function returns a truthy test result, the returned function suspends execution and immediately returns `false` for the test result (concurrent)', function test( t ) {
	var noneByAsync;
	var count;
	var arr;
