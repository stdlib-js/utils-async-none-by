...
```javascript
noneByAsync = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-none-by@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-async-none-by/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-async-none-by/actions/workflows/test.yml?query=branch:v0.2.2
