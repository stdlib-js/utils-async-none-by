...
```javascript
import noneByAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-none-by@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-none-by@v0.2.2-esm/index.mjs';
```
